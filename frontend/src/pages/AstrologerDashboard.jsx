...
const AstrologerDashboard = ({ user, onUserUpdate }) => {
    ...
    /* ── Photo Cropper/Adjustment State ── */
                            ...
                            <div className="glass-card">
                                ...
                                <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                                    ...
                                    <div>
                                        ...
                                        <label htmlFor="astro-photo-upload" className="btn btn-outline btn-sm" style={{ cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                                            <Edit size={14} /> {profile.image ? 'Change Photo' : 'Upload Photo'}
                                        </label>
                                        <input id="astro-photo-upload" type="file" accept="image/*" style={{ display: 'none' }} onChange={handleImageUpload} />
                                    </div>
                                </div>
